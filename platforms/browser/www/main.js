...
var PosztModalComponent = /** @class */ (function () {
    function PosztModalComponent(formBuilder, modalController, posztService, imagePicker) {
    ...
    PosztModalComponent.prototype.onPosztol = function () {
        ...
        if (this.posztForm.invalid) {
            ...
            this.posztService
                .createPoszt(poszt)
                .subscribe(function (tokenSub) {
                return tokenSub.subscribe(function (res) { return _this.modalController.dismiss(); });
            });
        }
    };

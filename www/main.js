...
/* harmony import */ var _poszt_modal_poszt_modal_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./poszt-modal/poszt-modal.component */ "./src/app/poszt-modal/poszt-modal.component.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"], _poszt_modal_poszt_modal_component__WEBPACK_IMPORTED_MODULE_11__["PosztModalComponent"]],
            entryComponents: [_poszt_modal_poszt_modal_component__WEBPACK_IMPORTED_MODULE_11__["PosztModalComponent"]],
            imports: [
...
/***/ "./src/app/poszt-modal/poszt-modal.component.html":
/*!********************************************************!*\
  !*** ./src/app/poszt-modal/poszt-modal.component.html ***!
  \********************************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>Új Poszt</ion-title>\n    <ion-buttons slot=\"secondary\">\n      <ion-button (click)=\"onKilep()\" color=\"danger\">\n        <ion-icon slot=\"icon-only\" name=\"exit\"></ion-icon>\n      </ion-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <form [formGroup]=\"posztForm\">\n    <ion-card-header>\n      <ion-card-title>Utazás posztolása</ion-card-title>\n    </ion-card-header>\n\n    <ion-card-content>\n      <ion-item>\n        <ion-label position=\"floating\">Cím</ion-label>\n        <ion-input formControlName=\"cim\"></ion-input>\n      </ion-item>\n\n      <ion-item>\n        <ion-label position=\"floating\">Megjegyzés</ion-label>\n        <ion-input formControlName=\"leiras\"></ion-input>\n      </ion-item>\n\n      <ion-item>\n        <ion-label position=\"floating\">Hely</ion-label>\n        <ion-input formControlName=\"helyszin\"></ion-input>\n      </ion-item>\n      <ion-button color=\"primary\" expand=\"full\" (click)=\"onFenykep()\">Fénykép</ion-button>\n      <ion-button color=\"primary\" expand=\"full\" type=\"submit\" (click)=\"onPosztol()\">Posztolás</ion-button>\n    </ion-card-content>\n  </form>\n</ion-content>"

/***/ }),

/***/ "./src/app/poszt-modal/poszt-modal.component.scss":
/*!********************************************************!*\
  !*** ./src/app/poszt-modal/poszt-modal.component.scss ***!
  \********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Bvc3p0LW1vZGFsL3Bvc3p0LW1vZGFsLmNvbXBvbmVudC5zY3NzIn0= */"

/***/ }),

/***/ "./src/app/poszt-modal/poszt-modal.component.ts":
/*!******************************************************!*\
  !*** ./src/app/poszt-modal/poszt-modal.component.ts ***!
  \******************************************************/
/*! exports provided: PosztModalComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PosztModalComponent", function() { return PosztModalComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _services_poszt_service_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/poszt-service.service */ "./src/app/services/poszt-service.service.ts");
...
var PosztModalComponent = /** @class */ (function () {
    function PosztModalComponent(formBuilder, modalController, posztService, imagePicker, toastController) {
        ...
        this.posztForm = this.formBuilder.group({
            cim: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            leiras: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            helyszin: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
        });
    }
    PosztModalComponent.prototype.ngOnInit = function () { };
    PosztModalComponent.prototype.onPosztol = function () {
        var _this = this;
        if (this.posztForm.invalid) {
            ...
            console.log(poszt);
            this.posztService.createPoszt(poszt).subscribe(function (tokenSub) {
                return tokenSub.subscribe(function (res) {
                    console.log(res);
    ...
    PosztModalComponent.prototype.onKilep = function () {
        this.modalController.dismiss();
    };
    PosztModalComponent.prototype.onFenykep = function () {
        var _this = this;
        var options = {
    ...
    PosztModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: "app-poszt-modal",
            template: __webpack_require__(/*! ./poszt-modal.component.html */ "./src/app/poszt-modal/poszt-modal.component.html"),
            styles: [__webpack_require__(/*! ./poszt-modal.component.scss */ "./src/app/poszt-modal/poszt-modal.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"],
            _services_poszt_service_service__WEBPACK_IMPORTED_MODULE_4__["PosztService"],
            _ionic_native_image_picker_ngx__WEBPACK_IMPORTED_MODULE_5__["ImagePicker"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ToastController"]])
    ], PosztModalComponent);
    return PosztModalComponent;
}());
...
var AuthService = /** @class */ (function () {
    function AuthService(http, localStorage) {
        ...
        this.serverAddress = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].serverAddress + "/auth/";
        this.localStorage.getItem("token").subscribe(function (token) {
            if (token) {
                _this.bejelentkezve = true;
            }
        });
    }
    AuthService.prototype.regisztracio = function (felhasznalo) {
        return this.http.post(this.serverAddress + "regisztracio", felhasznalo);
    };
    AuthService.prototype.bejelentkezes = function (felhasznalo) {
        var _this = this;
        this.http
            .post(this.serverAddress + "bejelentkezes", felhasznalo)
            .subscribe(function (valasz) {
            _this.localStorage.setItem("token", valasz["token"]).subscribe(function () { });
            _this.bejelentkezve = true;
        });
    };
    AuthService.prototype.getHTTPOptions = function () {
        return this.localStorage.getItem("token").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (token) {
            return {
    ...
    AuthService.prototype.profilAdatok = function () {
        var _this = this;
        return this.getHTTPOptions().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (httpOptions) {
            return _this.http
                .get(_this.serverAddress + "profil", httpOptions)
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _ngx_pwa_local_storage__WEBPACK_IMPORTED_MODULE_3__["LocalStorage"]])
    ], AuthService);
    return AuthService;
}());
...
/***/ "./src/app/services/poszt-service.service.ts":
/*!***************************************************!*\
  !*** ./src/app/services/poszt-service.service.ts ***!
  \***************************************************/
/*! exports provided: PosztService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PosztService", function() { return PosztService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
...
/* harmony import */ var _auth_service_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./auth-service.service */ "./src/app/services/auth-service.service.ts");
...
var PosztService = /** @class */ (function () {
    function PosztService(http, localStorage, authService) {
        this.http = http;
        this.localStorage = localStorage;
        this.authService = authService;
        this.serverAddress = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].serverAddress + "/poszt/";
    }
    PosztService.prototype.getPosztok = function () {
        return this.http.get(this.serverAddress);
    };
    PosztService.prototype.getSpecifiedPoszt = function (id) {
        return this.http.get(this.serverAddress + id);
    };
    PosztService.prototype.createPoszt = function (Poszt) {
        var _this = this;
        return this.authService
            .getHTTPOptions()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (httpOptions) {
            return _this.http.post(_this.serverAddress, Poszt, httpOptions);
        }));
    };
    PosztService.prototype.updatePoszt = function (Poszt, id) {
        return this.http.put(this.serverAddress + id, Poszt);
    };
    PosztService.prototype.deletePoszt = function (id) {
        return this.http.delete(this.serverAddress + id);
    };
    PosztService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: "root"
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"],
            _ngx_pwa_local_storage__WEBPACK_IMPORTED_MODULE_5__["LocalStorage"],
            _auth_service_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"]])
    ], PosztService);
    return PosztService;
}());
...
var environment = {
    production: false,
    serverAddress: "http://192.168.1.115:8000"
};
/*
...
module.exports = __webpack_require__(/*! /home/misi/Dokumentumok/travelis/src/main.ts */"./src/main.ts");
